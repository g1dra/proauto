...
<main id="page-content">
    ...
    <div class="slider-wrapper theme-default">
        <div id="slider" class="nivoSlider">
            <img src="images/slider/durmitor.jpg" title="#htmlcaption1" data-thumb="images/slider/slide_1.jpg" alt="" />
            <img src="images/slider/mm.jpg" title="#htmlcaption2" data-thumb="images/slider/slide_2.jpg" alt="" />
            <img src="images/slider/durmitor.jpg" title="#htmlcaption3" data-thumb="images/slider/slide_3.jpg" alt="" />
        </div>
        <div id="htmlcaption1" class="nivo-caption">
            <div class="nivo-caption__inner">
                <div class="text">
                    ...
                    <span class="showtext showtext__link"><a href="/#modal">Book a car and get discounts for car renting!</a></span>
                </div>
            </div>
        </div>
        <div id="htmlcaption2" class="nivo-caption">
            <div class="nivo-caption__inner left-side">
                <div class="text">
                    ...
                    <span class="showtext showtext__link"><a href="/#modal">It will be more fun with Pro Auto rent a car</a></span>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-6 col-lg-push-6">
                    <h1>Welcome</h1>
                    <p>Search for Rental cars in Montenegro? We offer a great selection of vehicles for best price. If you need car for short or long-term rental period, we can offer you additonal discounts. </p>
                    <p>Our service is available for you 24/7. If you have any further queries, please contact us.</p>
                        ...
                        @foreach($cars as $car)
                            <div class="model-info swiper-slide">
                                <figure class="thumbnail">
                                    <img src={{$car->img_path}} alt={{$car->alt}} style="max-height:400px"; onclick="sendCar({{json_encode($car)}})">
                                </figure>
                            ...
                            <div class="swiper-slide post-item" style="min-height: 450px !important;">
                                <div class="post-item__inner" style="min-height: 450px !important;">
                                    ...
                                    <div class="post-item__content">
                                        ...
                                        <h4>{{$post->title}}</h4>
                                        <a href="/posts/{{$post->id}}" class="btn btn__marker"><i class="icon-arrows"></i></a>
                                    </div>
                                </div>
                            </div>
                    @endforeach
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="phone-box wow zoomIn">
                    ...
                    <h3 class="phone-box__number">Call Now: <span><i class="icon-telephone"></i> +382-67-485-442</span></h3>
                </div>
            </div>
        </div>
    </div>
    <section class="car-info-box" data-wow-duration="1s" data-wow-delay="1s">
        <div class="car-info-box__description">
            <div class="desc-inner">
                ...
                <p>
                    Pro Auto Rent a Car is a company, that offers cheap car rentals in Montenegro. Our rich experiences ensure a great selection of vehicles at reasonable prices.
                    Our fleet of cars boasts newer cars, that offer absolute comfort.
                    Our goal is accessibility and user-friendliness. And our motto is: the best service for the best price.
                    Our company is located at  Podgorica downtown, and we can deliver the car at Airports in Montenegro or in hotels where you are located.
                </p>
            </div>
        </div>
